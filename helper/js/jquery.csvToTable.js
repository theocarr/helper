 ...
 */
 ...
 (function($){
	...
	*/
	...
	$.fn.CSVToTable = function(file, options) {
		var defaults = {
			tableClass: "CSVTable",
			theadClass: "",
			thClass: "",
          ...
          return false;
            ...
            var i=0;
						$.each(headers, function(headerCount, header) {
							...
							tableHTML += '<th class="' + options.thClass + '">' + header + '<div id=fieldTitle' + i +'></div>' + '<input class="headerradio" type="radio" name="optradio" value=' +i+'>'+ '</th>';
              i++;
						});
						tableHTML += '</tr></thead><tbody class="' + options.tbodyClass + '">';
